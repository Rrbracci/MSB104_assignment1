...
As mentioned earlier, the data include numbers from NUTS3 level

Som beskrevet over inneholder tallene fra NUTS3 level disse dataene.
Vi bestemte oss for å dele Tyskland inn i Nord og Sør pga.
(se comments).

Gå gjennom outliers ved å bruke Espen sitt tilsendte dokument.
F.eks.
beskrive Wolfsbrug, Hamburg etc.
Beskriv de laveste, si noe om hvorfor dette er tilfelle.

Beskrive finanskrisen og Covid i grafen.

Beskrive deskriptiv statistikk.
