...
Lastly, we created another new dataset called merged_data_GDP_PC and provided the summary function to get an overview of various summary statistics and information for each column in the merged_data_GDP_PC dataset.
...
The standard deviation of X € is probably caused by the two outliers, which has ...
