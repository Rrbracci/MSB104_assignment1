...
In year 2000, the region with highest GDP per capita was Hamburg (DE60), which is located in North Germany, with a GDP of 45,659 €.
Hamburg's high GDP in Germany can be attributed to several key factors.
First, Hamburg is home to a diverse range of industries, including maritime trade, logistics, manufacturing, aviation, and media.
This economic diversification contributes to a robust and stable economy.
Second, the Port of Hamburg is one of Europe's largest and busiest ports.
It serves as a major gateway for international trade, making Hamburg a crucial hub for import and export activities @imfnd.

The region with the lowest GDP per capita was Thüringen (DEG0), which is located in North Germany, with a GDP of 16,139 €.
Thüringen has one of the lowest GDPs in Germany due to several factors.
First, Thüringen has a relatively small and less diversified economy compared to other German states.
...
Second, Thüringen has a lower population compared to other regions.
A smaller population can lead to reduced economic output @thuringennd.
...
In year 2020, the region with highest GDP per capita was still Hamburg (DE60), with a GDP of 64,366 €, and the region with the lowest GDP per capita was still Thüringen (DEG0), with a GDP of 28,874 €.

In Germany in 2020, GDP per capita had an average value (mean) of 39,439 €.
...
In year 2000, the region with highest GDP per capita was Helsinki-Uusimaa (FI1B), with a GDP of 36,478 €.
Helsinki-Uusimaa is one of the regions in Finland with the highest GDP per capita for several reasons.
...
It is home to numerous businesses, corporate headquarters, government institutions, and educational and research facilities.
The presence of these institutions contributes significantly to the region's economic activity (**SOURCE**).

The region with the lowest GDP per capita was Pohjois- ja Itä-Suomi (FI1D), with a GDP of 20,605 €.
Pohjois- ja Itä-Suomi is one of the regions in Finland with lower GDP per capita for several reasons.
For instance, its located in Northern and Eastern Finland, which characterized by their vast, sparsely populated areas and harsh climatic conditions.
These factors can limit economic activities in certain sectors, such as agriculture and construction, which may thrive more in milder climates and more densely populated regions (**SOURCE**).
...
In year 2020, the region with highest GDP per capita was still Helsinki-Uusimaa (FI1B), with a GDP of 55,750 €, and the region with the lowest GDP per capita was still Pohjois- ja Itä-Suomi (FI1D), with a GDP of 36,072 €.
...
In year 2000, the region with highest GDP per capita was București-Ilfov (RO32), with a GDP of 3972 €.
București-Ilfov is the region with the highest GDP in Romania for several reasons.
...
This concentration of administrative and economic activity contributes significantly to the region's GDP (**SOURCE**).

The region with the lowest GDP per capita was Nord-Est (RO21), with a GDP of 1253 €.
Nord-Est is one of the regions in Romania with the lowest GDP for several reasons.
...
This agricultural dependency can limit the region's overall economic output (**SOURCE**).
...
In year 2020, the region with highest GDP per capita was still București-Ilfov (RO32), with a GDP of 26,270 €, and the region with the lowest GDP per capita was still Nord-Est (RO21), with a GDP of 7478 €.

In Romania in 2020, the average GDP per capita was around 11,628 €, however there is still significant variation in income levels across different regions or segments of the population.
